...
public class Ejercicio4 {
	/*
	 * Hacer un programa en el que se simula la compra de entradas en el museo de la
	 * siguiente forma: Por cada grupo que llega se anota el número de adultos y el
	 * número de niños y si se aplica tarifa reducida o no. Con esta información se
	 * calcula el importe total de las entradas de cada grupo y se muestra por
	 * pantalla. El programa termina cuando se hayan recaudado más de 100 euros.
	 * Mostrar al final el número de entradas del grupo que más entradas ha
	 * comprado.
	 */
	public static void main(String[] args) {
		...
		do {
			...
			EntradasTotales = Adultos + Niños;
			if (EntradasTotales > NumEntradas) {
				NumEntradas = EntradasTotales/2;
			}
